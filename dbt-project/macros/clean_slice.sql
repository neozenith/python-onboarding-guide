{% macro clean_slice(debug_logging=false) -%}
        ...
        {#- TODO: Include special environment variables as part of the naming conventions for a slice.https://docs.getdbt.com/docs/build/environment-variables#special-environment-variables -#} 
        ...
        {%- set branch_slice = re.sub("\W", "_", env_var('DBT_CLOUD_GIT_BRANCH', env_var('DBT_GIT_BRANCH', var('git_branch')))) -%}
